...
def test1():
    """ Simple maze """
    from vgdl.examples.gridphysics.mazes.mazegames import maze_game
    from vgdl.examples.gridphysics.mazes.simple import maze_level_2
...
def test2():
    ...
    from vgdl.examples.gridphysics.mazes.mazegames import maze_game, polarmaze_game
    from vgdl.examples.gridphysics.mazes.simple import maze_level_2, office_layout_2
    pylab.subplot(2,2,1)
    plotOptimalValues(maze_game, maze_level_2)
    pylab.subplot(2,2,2)
...
def test3():
    """ Stochastic maze. """    
    from vgdl.examples.gridphysics.mazes.windy import windy_stoch_game, windy_level
...
def test5():
    from vgdl.examples.gridphysics.mazes.mazegames import maze_game, flippolarmaze_game
    from vgdl.examples.gridphysics.mazes.noisyobservations import maze_89
    pylab.subplot(1,2,1)
